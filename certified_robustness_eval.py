...
if __name__ == '__main__':
    ...
    parser.add_argument("--classifier_path", default='audio_models/ConvNets_SpeechCommands/checkpoints/sc09-resnext29_8_64_sgd_plateau_bs96_lr1.0e-02_wd1.0e-02-best-acc.pth')
    ...
    parser.add_argument('--num_sampling', type=int, default=100000)

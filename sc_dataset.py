...
__all__ = [ 'CLASSES', 'SpeechCommandsDataset', 'SC09Dataset', 'BackgroundNoiseDataset', 'UrbanSound8k', 'Qualcomm']
...
qualcomm = 'hey_android, hey_snapdragon, hi_galaxy, hi_lumina'.split(', ')

class Qualcomm(Dataset):

    def __init__(self, folder, transform=None, classes=qualcomm, num_per_class=4):
